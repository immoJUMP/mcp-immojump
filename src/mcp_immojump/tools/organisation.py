...
def register(mcp):
    @mcp.tool(title='List organisations', annotations=read_only())
    ...
    @mcp.tool(title='Get organisation', annotations=read_only())
    ...
    @mcp.tool(title='Update organisation', annotations=write_op())
    ...
    @mcp.tool(title='List organisation members', annotations=read_only())
    ...
    @mcp.tool(title='Update organisation member', annotations=write_op())
    ...
    @mcp.tool(title='Update member roles', annotations=write_op())
    ...
    @mcp.tool(title='Remove organisation member', annotations=destructive_op())
    ...
    @mcp.tool(title='List organisation invites', annotations=read_only())
    ...
    @mcp.tool(title='Invite user to organisation', annotations=write_op())
    ...
    @mcp.tool(title='Cancel organisation invite', annotations=destructive_op())
    ...
    @mcp.tool(title='List organisation roles', annotations=read_only())
    ...
    @mcp.tool(title='Create organisation role', annotations=write_op())
    ...
    @mcp.tool(title='Update organisation role', annotations=write_op())
    ...
    @mcp.tool(title='Delete organisation role', annotations=destructive_op())
    ...
    @mcp.tool(title='Get report design', annotations=read_only())
    ...
    @mcp.tool(title='Rebuild report design', annotations=write_op())
